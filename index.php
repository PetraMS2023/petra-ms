...
<body>
      ...
      <div class="links">
        <div class="ls">
          <ul class="mainLinks">
            ...
            <li><a class="link" href="http://careers.petra-ms.com/">careers</a></li>
          </ul>
          <div class="mLinks">
  ...
  <div class="home">
    ...
    <div class="homeMedia" id="homeMedia">
      ...
      <div class="hlk">
        <a class="fadeL" href="https://www.facebook.com/petramsjo"><img src="./media/icons/facebook.png" alt=""></a>
        <a class="fadeL200" href="https://www.instagram.com/petramarketingjo/"><img src="./media/icons/instagram.png" alt=""></a>
        <a class="fadeL400" href="https://api.whatsapp.com/send/?phone=%2B962791231333&text&type=phone_number&app_absent=0"><img src="./media/icons/whatsapp.png" alt=""></a>
        <a class="fadeL600" href="https://www.linkedin.com/company/90782606/admin/feed/posts/"><img src="./media/icons/linkedin.png" alt=""></a>
      </div>
    </div>
  </div>
  <!-- end home -->
  ...
  <div class="container">
        ...
        <div class="swiper adsSw">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <img src="./media/adsEn1.png" alt="">
            </div>
            <div class="swiper-slide">
              <img src="./media/adsEn2.png" alt="">
            </div>
            <div class="swiper-slide">
              <img src="./media/adsEn3.png" alt="">
            </div>
            <div class="swiper-slide">
              <img src="./media/post.png" alt="">
            </div>
          </div>
    ...
    <div class="section">
      <div class="box sec">
        ...
        <div class="serv-box">
          <div class="s-serv js-scroll fade-btm">
          ...
          <div class="s-serv js-scroll fade-top">
      ...
      <div class="box sec clients">
        ...
        <div class="swiper mySwiper js-scroll fade-btm">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/Abykwaik-Logo new.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/baby-life-logo-png.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/baseel.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/BDO_logo.svg.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/hamdan-logo.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/health  (1)-01.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/I MOTO.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/JOURY.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/lerose .png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/logo dana Page 1-01.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/افران الياسمين .png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/ركن الاصالة.png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/طربوش .png" alt="">
              </div>
            </div>
            <div class="swiper-slide">
              <div class="client">
                <img src="./media/logos/old/الغرباء.png" alt="">
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="box footer">
      ...
      <div class="footerLinkGroup">
        <div class="linkGroup">
          <h2>helpful link</h2>
          <ul>
            <li><a href="https://pzk-group.com/"><img src="./media/icons/footerLink.png" alt=""> PZK Groupe</a></li>
        ...
        <div class="linkGroup cont">
          <h2>Contact US</h2>
          <ul>
            <li><a href="https://maps.app.goo.gl/FrCWf3QbhFePCBP39"><img src="./media/icons/location.png" alt="">QJ center, Abdallah Ghosheh St , Amman</a></li>
          ...
          <div class="media">
            ...
            <a href="https://www.instagram.com/petramarketingjo/"><i class="fa-brands fa-instagram"></i></a>
