    ...
    items: [
      {
        ...
        content:
          "We develop high-quality mobile applications for Android and iOS platforms. Our apps are designed to enhance user experience and achieve your business goals.",
      },
      {
        title: "Custom Web Development",
        content:
          "Our custom web development services provide unique and scalable solutions to help your business grow. We build from scratch to meet your specific requirements.",
      },
      {
        title: "Website",
        content:
          "We create stunning and functional websites tailored to your business needs. Our designs are user-friendly and optimized for all devices.",
      },
    ],
  },
  {
    ...
    items: [
      {
        title: "Drone",
        content:
          "We offer aerial photography services using drones to capture events and locations from unique and innovative angles. Our high-quality footage helps achieve your commercial and creative goals.",
      },
      {
        title: "Photoshoots",
        content:
          "We provide professional photoshoots to showcase your products or services in the best light. We focus on details to ensure images reflect the quality of your work and attract potential customers.",
      },
      {
        title: "Videography",
        content:
          "We offer innovative videography services to document events or promote your products. We create engaging and professional visual content that enhances your digital presence.",
      },
      {
        title: "Kitchen Photography Studio",
        content:
          "Our kitchen photography studio specializes in capturing high-quality images of your dishes, highlighting every detail to entice customers and boost your sales.",
      },
      {
        title: "Cinematography",
        content:
          "We provide cinematography services to create high-quality short films and visual content that effectively tells your stories in a professional and captivating manner.",
      },
      {
        title: "Storyboard",
        content:
          "We assist in designing storyboards that represent your vision for projects and films, allowing you to visualize and organize scenes effectively before production begins.",
      },
      {
        title: "Podcast",
        content:
          "We offer podcast recording and production services to deliver your messages in a distinctive audio format. We ensure high-quality, engaging content for your audience.",
      },
      {
        title: "Voiceover",
        content:
          "We provide voiceover services to add a professional touch to your projects. We deliver unique voices suitable for various types of content.",
      },
      {
        title: "Live stream",
        content:
          "We help you organize live streaming of events and occasions professionally. We ensure high-quality broadcasts and smooth real-time interaction with your audience.",
      },
    ],
  },
  {
...
function showItems(element) {
  ...
  if (filterd.length !== 0) {
    ...
    for (let i = 0; i < filterd[0].items.length; i++) {
      itemsInner.innerHTML += `
      <div class="item opacity" style="animation: fadebtm 800ms alternate ${(i + 1) * 100
        }ms forwards;">
